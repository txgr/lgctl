...
import (
	...
	"github.com/txgr/lgctl/api/swagger"

	"github.com/txgr/lgctl/api/apigen"
	"github.com/txgr/lgctl/api/docgen"
	"github.com/txgr/lgctl/api/format"
	"github.com/txgr/lgctl/api/gogen"
	"github.com/txgr/lgctl/api/new"
	"github.com/txgr/lgctl/api/validate"
	"github.com/txgr/lgctl/config"
	"github.com/txgr/lgctl/internal/cobrax"
	"github.com/txgr/lgctl/plugin"
)
